  ...
  '/stats/flow':
    delete:
      ...
      parameters:
        - name: flowentry
          in: body
          description: Flow entry deletion
          required: false
          schema:
            $ref: '#/definitions/flowentry'
      responses:
    ...
    post:
      ...
      parameters:
        ...
        - name: flowentry
          in: body
          description: >-
            Flow information. If OFv1.3 or earlier: 'actions', if OFv1.4 or
            later: 'instrucions'
          schema:
            $ref: '#/definitions/flowentry'
      responses:
...
definitions:
  ...
  rule:
    ...
    properties:
      priority:
        description: >-
          Priority of the rule between 0 and 65533. When 'priority' has not been
          set up, priority: 1' is set
        type: integer
        minimum: 0
        maximum: 65533
        default: 1
  ...
  meter:
    type: object
    description: >-
      Meters declaration. The parameters specified in the bands depend on the
      flag type.
    properties:
      meter_id:
        type: integer
